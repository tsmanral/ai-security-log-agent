"""
AI-Sentinel V3 — IP geolocation resolver.
...
from ai_sentinel.storage.database import get_unresolved_ips, upsert_ip_geolocation
...
def _resolve_ip(ip_address: str) -> Optional[Tuple[float, float, str, str]]:
    ...
    try:
        ...
        geolocator = Nominatim(user_agent="ai-sentinel-v3")
