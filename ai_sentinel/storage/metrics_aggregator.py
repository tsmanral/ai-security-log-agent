"""
AI-Sentinel V3 — Metrics pre-aggregation.
...
from ai_sentinel.config import METRICS_AGGREGATION_INTERVAL_MINUTES
from ai_sentinel.storage.database import get_connection, upsert_metrics_5min
