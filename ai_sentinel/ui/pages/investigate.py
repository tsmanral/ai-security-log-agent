"""
AI-Sentinel V4 — Analyst Investigation Page.
...
from ai_sentinel.features.feature_extractor import build_entity_timeline
from ai_sentinel.explainability.narrative_builder import (
...
def _render_case_file():
    ...
    with st.expander("✅ View Recommended Actions"):
        from ai_sentinel.explainability.narrative_builder import _get_recommendations
