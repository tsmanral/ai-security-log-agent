"""
AI-Sentinel V3 — Model Analytics page.
...
from ai_sentinel.ui.data_layer import get_dashboard_drift, get_dashboard_model_info
...
def render():
    ...
    for model_name in models_to_check:
        ...
        if drift_records:
            ...
            from ai_sentinel.config import PSI_DRIFT_THRESHOLD
            fig.add_hline(
