"""
AI-Sentinel V3 — Threat Intelligence page.
...
from ai_sentinel.storage.database import get_connection, get_threat_intel
from ai_sentinel.ui.components.chart_theme import apply_soc_theme, SEVERITY_COLORS
