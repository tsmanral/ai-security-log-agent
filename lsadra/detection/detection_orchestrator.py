"""
LSADRA V3 — Detection orchestrator (pipeline).
...
from lsadra.detection.severity import compute_severity_score, severity_context
from lsadra.features.feature_extractor import FEATURE_COLS, build_features
