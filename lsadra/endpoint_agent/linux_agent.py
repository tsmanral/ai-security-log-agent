...
logger = logging.getLogger("lsadra-agent")
...
def main():
    parser = argparse.ArgumentParser(description="LSADRA Linux Endpoint Agent")
    parser.add_argument("--config", default="/etc/lsadra-agent/config.yml")
