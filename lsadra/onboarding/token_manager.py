"""
LSADRA V2 — Registration token manager.
...
from lsadra.config import REGISTRATION_TOKEN_LIFETIME_MINUTES
from lsadra.storage.database import consume_token, store_token
